...
import brandLogo from '../../assets/images/Logo-SweepWidget-new-small.webp';
...
const Navbar = () => {
  ...
  return <>
    <AppBar position="static" className='nav-bg'>
      <Container maxWidth="xl" sx={{ paddingLeft: {xs: "15px", md: "45px"}, paddingRight: {xs: "15px", md: "45px"} , maxWidth: "100%" }}>
          ...
          <div className='nav-main-div'>
            ...
            <div>
              <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                ...
                <Button className='signin-btn' size='small' variant="contained">Sign Up Free</Button>
              </Box>
